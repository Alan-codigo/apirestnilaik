...
public class Producto {
    ...
    @Column(name = "PrecioMayoreo", nullable = false)
    private Integer precioMayoreo;
    
    @Column(name = "preciomenudeo", nullable = false)
    ...
    public Producto(String articulo, String marca, Integer talla, String codigo, String color, Integer precioMayoreo, Integer precioMenudeo, Integer existencias, Integer imgproducto_idimgproducto) {
